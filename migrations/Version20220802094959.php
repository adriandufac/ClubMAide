 ...
 */
final class Version20220802094959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD campus_id INT NOT NULL, ADD participants_organisateurs_id INT NOT NULL, ADD etat_id INT NOT NULL, ADD lieu_id INT NOT NULL, DROP etat');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat VARCHAR(50) NOT NULL, DROP campus_id, DROP participants_organisateurs_id, DROP etat_id, DROP lieu_id');
    }
}
